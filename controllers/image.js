...
module.exports = {
  ...
  create: function(req, res) {
    var saveImage = function() {
      var possible = 'abcdefghijklmnopqerstuvwxyz0123456789',
          imgUrl = '';

      for(var i=0;i < 6;i++){
        imgUrl = imgUrl + possible.charAt(Math.floor(Math.random()*possible.length));
      }
        ...
        if(images.length > 0){
          ...
          if(ext === '.png' || ext === '.jpg' || ext === '.jpeg' || ext === '.gif'){
            ...
            fs.unlink(tempPath, function(err) {
              ...
              res.json(500, {error: 'Only image files are alowed.'});
            });
          }
        }
      });
